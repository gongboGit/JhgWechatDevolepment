...
public class WXPayUtil {
    ...
    public static String aesDdecrypt(byte[] b, WXPayConfigImpl config) throws Exception {
        
        String key = WXPayUtil.MD5(config.getKey());
        Cipher cipher = Cipher.getInstance(ALGORITHM_MODE_PADDING);
        cipher.init(Cipher.DECRYPT_MODE, new SecretKeySpec(key.toLowerCase().getBytes(), "AES"));
