    ...
    var e = layui.$, i = layui.layer, a = layui.form, l = (layui.hint(), layui.device()), n = "layedit",
        o = "layui-show", r = "layui-disabled", c = function () {
            ...
            t.index = 0, t.config = {
                ...
                url:r.url,method:r.type, hideTool: [],
                height: 280
            }
        };
        ...
        var n = t.document, o = e(n.body), c = {
            link: function (i) {
                ...
                x.call(this, function (i) {
                    v.call(t, "img", {src: i.src, alt: i.alt, style:'display:inline-block;max-width:50%;height:auto'}, e)
                })
            }, image: function (a) {
                var n = this;
                layui.use("upload", function (o) {
                    var r = l.uploadImage || {};
                    o.render({
                        url: r.url, method: r.type, size: r.size, elem: e(n).find("input")[0], done: function (e) {
